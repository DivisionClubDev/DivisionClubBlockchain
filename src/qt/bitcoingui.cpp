                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Divc Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a DIVC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and divc: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Divc Core"), this);
    aboutAction->setStatusTip(tr("Show information about Divc Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Divc"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your DIVC addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified DIVC addresses"));
    ...
    openAction->setStatusTip(tr("Open a divc: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Divc Core help message to get a list with possible Divc command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Divc Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Divc network", "", count));
}
...
{
    QString strTitle = tr("Divc Core"); // default title
