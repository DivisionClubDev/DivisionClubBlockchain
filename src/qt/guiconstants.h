...
/* Divc GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Divc"
#define QAPP_ORG_DOMAIN "divccoin.io"
#define QAPP_APP_NAME_DEFAULT "Divc-Qt"
#define QAPP_APP_NAME_TESTNET "Divc-Qt-testnet"
