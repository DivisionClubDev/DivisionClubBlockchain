...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Divc features */
        {"divc", "masternode", &masternode, true, true, false},
        {"divc", "listmasternodes", &listmasternodes, true, true, false},
        {"divc", "getmasternodecount", &getmasternodecount, true, true, false},
        {"divc", "masternodeconnect", &masternodeconnect, true, true, false},
        {"divc", "masternodecurrent", &masternodecurrent, true, true, false},
        {"divc", "masternodedebug", &masternodedebug, true, true, false},
        {"divc", "startmasternode", &startmasternode, true, true, false},
        {"divc", "createmasternodekey", &createmasternodekey, true, true, false},
        {"divc", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"divc", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"divc", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"divc", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"divc", "getmasternodescores", &getmasternodescores, true, true, false},
        {"divc", "mnbudget", &mnbudget, true, true, false},
        {"divc", "preparebudget", &preparebudget, true, true, false},
        {"divc", "submitbudget", &submitbudget, true, true, false},
        {"divc", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"divc", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"divc", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"divc", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"divc", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"divc", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"divc", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"divc", "checkbudgets", &checkbudgets, true, true, false},
        {"divc", "mnsync", &mnsync, true, true, false},
        {"divc", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> divc-cli " + methodname + " " + args + "\n";
}
