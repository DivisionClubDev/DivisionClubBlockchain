...
RESOURCES += src/qt/divc.qrc src/qt/divc_locale.qrc

TRANSLATIONS += src/qt/locale/divc_bg.ts \
                src/qt/locale/divc_de.ts \
                src/qt/locale/divc_en.ts \
                src/qt/locale/divc_es.ts \
                src/qt/locale/divc_fi.ts \
                src/qt/locale/divc_fr.ts \
                src/qt/locale/divc_it.ts \
                src/qt/locale/divc_ja.ts \
                src/qt/locale/divc_pl.ts \
                src/qt/locale/divc_pt.ts \
                src/qt/locale/divc_ru.ts \
                src/qt/locale/divc_sk.ts \
                src/qt/locale/divc_sv.ts \
                src/qt/locale/divc_vi.ts \
                src/qt/locale/divc_zh_CN.ts \
                src/qt/locale/divc_zh_TW.ts
