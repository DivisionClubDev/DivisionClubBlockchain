Contributing to Divc Core
==================================

The Divc Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Divc Core project, and is not to be
confused with overall Divc Network Protocol consensus changes.

Whether a pull request is merged into Divc Core rests with the project merge
...
Patches that change Divc consensus rules are considerably more involved than
...
Where a patch set proposes to change the Divc consensus, it must have been
...
The project leader is the release manager for each Divc Core release.
