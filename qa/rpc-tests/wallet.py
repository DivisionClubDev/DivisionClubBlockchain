...
#   c) node1 mines 32 blocks, so now node 0 has 500000DIVC, node 1 has 4250DIVC, node2 has none.
#   d) node0 sends 601 DIVC to node2, in two transactions (301 DIVC, then 300 DIVC).
