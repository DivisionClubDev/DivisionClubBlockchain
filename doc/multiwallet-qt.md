...
In order to support loading of multiple wallets in divc-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is divc.cpp.
...
Changes to divc.cpp
----------------------
divc.cpp is the entry point into divc-qt, and as such, will require some minor modifications to provide hooks for
