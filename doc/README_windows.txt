...
Intro
-----
Divc (DIVC) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Divc utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run divc-qt.exe.

Divc Core is the original Divc client and it builds the backbone of the network.
However, it downloads and stores the entire history of Divc transactions;
